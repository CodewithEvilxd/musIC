    ...
    >
      ...
      {/* <div className="w-full relative text-white p-10 sm:p-3 sm:gap-3 h-[65vh] overflow-y-auto flex sm:block flex-wrap gap-7 justify-center ">
        ...
        <div className="flex gap-3 text-2xl  ">
            <h1>MADE BY ❤️ NISHANT GAURAV</h1>
            <a
              target="_blank"
              href="https://www.instagram.com/game_changer.09/"
            >
      ...
      <motion.div
        className={
          songlink.length > 0
            ? ` duration-700 flex fixed z-[99] bottom-0     gap-3 items-center  w-full py-3 sm:h-[30vh] h-[20vh] backdrop-blur-xl  `
            : "block"
        }
      >
        {songlink?.map((e, i) => (
